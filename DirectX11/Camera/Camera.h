...
struct Camera
{
	...
	XMMATRIX GetViewMatrix()
	{
		...
		return  XMMatrixLookAtLH(XMVectorSet(Position[0], Position[1], Position[2], 0.0f), XMVectorSet(Position[0], Position[1], Position[2], 0.0f) + XMVectorSet(Front[0], Front[1], Front[2], 0.0f), XMVectorSet(Up[0], Up[1], Up[2], 0.0f));
	}
